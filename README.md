...
- **Approve tool calls from your phone** — interactive polls for file edits, bash commands, etc.
- **Route sessions to groups or forum topics** — each agent gets its own chat
